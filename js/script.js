...
const quizdata=[
      {
        question:"You Received Strange Email, And You Suspect That An Email Or Text Message You Recived Is A Phishing  What Would Be Your First Reaction? ",
        options:["Open Email", "Delete Email", "Ignore Email", "Report It"],
        answer:"Report It",
        category:1
      },
      {
        question:"Which of the following options is the most effective way to improve email phishing security?",
        options:["A phishing test", "A corporate firewall", "Virtual private network", "None of it"],
        answer:"A phishing test",
        category:2
      },
      {
        question:"True or false: IT leaders need to communicate the security risks of deepfake technology to all employees.",
        options:["True", "False"],
        answer:"False",
        category:3
      },
      {
        question:"Who are the targets of whaling phishing attacks?",
        options:["Intro-level employees", "Executives", "Middle management", "All of the above"],
        answer:"All of the above",
        category:1
      },
      {
        question:"If you fall for a phishing scam email password, what should you do to limit the damage?",
        options:["Delete phishing email.", "Unplug the computer", "Change Password", "Ignore"],
        answer:"Change Password",
        category:2
      },
      {
        question:"An email from your boss asks for the name, addresses, and credit card information of the company’s top clients. The email says it’s urgent and to please reply right away. You should reply right away. True or False?",
        options:["True", "False"],
        answer:"True",
        category:3
      },
      ...
      },
      {
        ...
        options:["Unplug your mouse", "Tell your supervisor", "Run anti-virus", "All of the above"],
        answer:"All of the above",
        category:3
      },
      {
        question:"You receive an email from 'hajhsyye@sound.ocn.ne.jp' that urges you to reset your Facebook password. What should you do?",
        options:["Ignore & Report", "Yes, I will share", "Click the links", "Follow their instructions"],
        answer:"Ignore & Report",
        category:1
      },
      {
        question:"You receive an strange email from your bank telling you there is a problem with your account. The email provides instructions and a link so you can log in to your account and fix the problem. What should you do?",
        options:["Call The Bank-Check & Report", "Open Email Link", "Delete Email", "I dont know"],
        answer:"Call The Bank-Check & Report",
        category:2
      },
      {
        question:" How often should you change your  password?",
        options:["Never", "Every year", "Every week", "Every few months"],
        answer:"Every few months",
        category:3
      },
      {
        question:"Is it generally considered safe to use Free Public Wi-Fi network for performing an online banking operation?",
        options:["Yes, it is safe", "No, it is dangerous"],
